---
layout: default
title: Sergei Klimov — Senior / Lead Go Blockchain Engineer
description: >-
  Lead Go blockchain engineer at NuConstruct (Ethereum MEV / TOOL Node on
  go-ethereum). Author of EVAA's official Go SDK. Upstream contributor to
  Prysm, MEV-Boost, Cosmos IAVL, Tendermint tm-db.
keywords: golang, go, blockchain, ethereum, mev, mev-boost, prysm, go-ethereum, ton, funC, cosmos, tendermint, iavl
permalink: /
---

# Sergei Klimov

**Senior / Lead Go Blockchain Engineer** · Rio de Janeiro, Brazil
...
*April 2024 – March 2025 · Remote · [evaaprotocol.com](https://evaaprotocol.com/)*
